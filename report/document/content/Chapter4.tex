...
KGE-NFM (Knowledge Graph Embedding--Neural Factorization Machine) is the main
DTI prediction framework studied in this report. It follows a two-stage design.
First, a knowledge graph encoder learns drug and protein representations from
biomedical triples. Second, these representations are combined with molecular
and sequence descriptors and processed by an NFM to predict DTI labels.

This report evaluates two alternative encoder configurations within the same
...
\cite{YangYHGD14a}. For a triple $(h,r,t)$:
...
\cite{VashishthSNT20}. Unlike a standard GCN, it must account for
...
The project configuration primarily controls embedding dimension, layer count,
...
principle in \cite{0001C17}. Each input field
